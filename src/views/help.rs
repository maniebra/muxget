...
pub const PAGES: &[Page] = &[
    Page {
        ...
        lines: &[
            ...
            "S\tsync every channel in settings › channels",
            "s\tsettings",
            "?\tthis manual",
            "q / ZZ\tquit",
            "",
    ...
    Page {
        ...
        lines: &[
            ...
            "",
            "Dates come with the listing, so a range is nearly free: only entries",
            "sitting close to an end of it are opened for their exact date.",
            "",
            "settings › channels keeps a list of channels with the day each was last",
            "synced. `s` on a row lists everything uploaded since that day and opens",
            "the picker; `S` — there or in the list — syncs every channel and queues",
            "what it finds. Either way the last sync moves to today.",
        ],
    },
    Page {
        name: "crawl",
    ...
    Page {
        ...
        lines: &[
            ...
            "channels\tchannels to keep up with: n new, s sync one, S sync all",
